      ...
      <div x-data="setup()" :class="{ 'dark': isDark }">
          <div class="min-h-screen flex flex-col flex-auto flex-shrink-0 antialiased bg-white dark:bg-gray-700 text-black dark:text-white">
            ...
            <div class="fixed w-full flex items-center justify-between h-14 text-white z-10">
              ...
              <div class="relative flex justify-between items-center h-14 bg-blue-800 dark:bg-gray-800 header-right">
            ...
            <!-- Sidebar -->
            <div class="fixed flex flex-col my-16 top-14 left-0 w-14 hover:w-64 md:w-64 bg-blue-900 dark:bg-gray-900 h-full text-white transition-all duration-300 border-none z-10 sidebar">
              <div class="overflow-y-auto overflow-x-hidden flex flex-col justify-between flex-grow">
                <ul class="flex flex-col py-4 space-y-1">
                  <li class="px-5 hidden md:block">
                    <div class="flex flex-row items-center h-8">
                      <div class="text-sm font-light tracking-wide text-gray-400 uppercase">BlueStream</div>
                    </div>
                  </li>
                  <li>
        ...
        <div class="mt-8 mx-4">
            <div class="p-4 bg-blue-50 dark:bg-gray-800 dark:text-gray-50 border border-blue-500 dark:border-gray-500 rounded-lg shadow-md">
              ...
              <ul>
                <li class="mt-3">
                  <a class="flex items-center text-blue-700 dark:text-gray-100" href="{{ route('videos') }}">
                    ...
                    <span class="inline-flex pl-2">Liste de vidéos</span>
                  </a>
                </li>
